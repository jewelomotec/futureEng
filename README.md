...
6. Pause, then rejoin the **pre-block heading**. Green adds a right pull toward the original middle; red does not. New `WAYPOINT`s for that pillar are ignored until CLEAR / timeout.
